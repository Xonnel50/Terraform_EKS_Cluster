...
resource "aws_iam_role_policy_attachment" "eks_nodes-AmazonEKSWorkerNodePolicy" {
...
resource "aws_iam_role_policy_attachment" "eks_nodes-AmazonEC2ContainerRegistryReadOnly" {
  role       = aws_iam_role.eks_node.name
